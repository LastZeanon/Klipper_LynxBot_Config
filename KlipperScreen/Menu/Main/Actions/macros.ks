...
icon: bed-mesh
method: printer.gcode.script
params: {"script":"SET_DEFAULT_BEACON_MODEL_TEXTURED_BLACK"}

[menu __main Actions Macros Bed-Mesh Set_Default_Beacon_Model SMOOTH_BLACK]
name: Smooth Black
icon: bed-mesh
method: printer.gcode.script
params: {"script":"SET_DEFAULT_BEACON_MODEL_SMOOTH_BLACK"}

[menu __main Actions Macros Bed-Mesh Set_Default_Beacon_Model TEXTURED_ALCHEMY]
name: Textured Alchemy
icon: bed-mesh
method: printer.gcode.script
params: {"script":"SET_DEFAULT_BEACON_MODEL_TEXTURED_ALCHEMY"}

[menu __main Actions Macros Bed-Mesh Set_Default_Beacon_Model SMOOTH_ALCHEMY]
name: Smooth Alchemy
icon: bed-mesh
method: printer.gcode.script
params: {"script":"SET_DEFAULT_BEACON_MODEL_SMOOTH_ALCHEMY"}

[menu __main Actions Macros Bed-Mesh Set_Default_Beacon_Model TEXTURED_SCRATCHED]
name: Textured Scratched
icon: bed-mesh
method: printer.gcode.script
params: {"script":"SET_DEFAULT_BEACON_MODEL_TEXTURED_SCRATCHED"}

[menu __main Actions Macros Bed-Mesh Set_Default_Beacon_Model CARBON_SCRATCHED]
name: Carbon Scratched
icon: bed-mesh
method: printer.gcode.script
params: {"script":"SET_DEFAULT_BEACON_MODEL_CARBON_SCRATCHED"}

[menu __main Actions Macros Bed-Mesh Set_Default_Beacon_Model TEXTURED_GOLD]
name: Textured Gold
icon: bed-mesh
method: printer.gcode.script
params: {"script":"SET_DEFAULT_BEACON_MODEL_TEXTURED_GOLD"}

[menu __main Actions Macros Bed-Mesh Set_Default_Beacon_Model CARBON_GOLD]
name: Carbon Gold
icon: bed-mesh
method: printer.gcode.script
params: {"script":"SET_DEFAULT_BEACON_MODEL_CARBON_GOLD"}
